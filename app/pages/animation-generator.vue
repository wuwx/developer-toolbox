<template>
  <UContainer class="py-8 sm:py-12">
    <UPageHeader title="CSS 动画生成器" description="可视化生成 CSS 动画" align="center">
      <template #icon>
    ...
    <div class="grid lg:grid-cols-2 gap-8">
      <div class="space-y-6">
        <UCard>
          <template #header><h3 class="font-semibold">动画属性</h3></template>
          <div class="space-y-4">
            <div>
            ...
            <div>
              <label class="text-sm font-medium mb-2 block">延迟: {{ delay }}s</label>
...
useHead({ title: 'CSS 动画生成器 | 开发者工具箱' })
</script>
